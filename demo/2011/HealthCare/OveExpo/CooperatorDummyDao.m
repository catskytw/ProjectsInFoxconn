...
-(CooperatorDataObject*)getCooperatorData:(NSString*)_cooperatorId{
    ...
    switch (m_type) {
        case 0:
            ...
            m_returnObject.webSite=@"http://www.kmuh.org.tw/";
            break;
        case 1:
            ...
            m_returnObject.webSite=@"http://www.kmhk.kmu.edu.tw/";
            break;
        case 2:
            ...
            m_returnObject.webSite=@"http://www.sinlau.org.tw/";
            break;
        case 3:
            ...
            m_returnObject.address=@"70142 台南市東門路一段57號";
            m_returnObject.email=@"slh193@sinlau.org.tw";
            m_returnObject.webSite=@"http://www.pntn.doh.gov.tw/";
            break;
        case 4:
            m_returnObject.objName=@"惠德醫院";
            m_returnObject.phone=@"08-736-3011#4203";
            m_returnObject.address=@"90054 屏東縣屏東市自由路270號 ";
            m_returnObject.email=@"aul452@gmail.com";
            m_returnObject.webSite=@"http://www.etan.com.tw/huide_hosp/big5/site_item_content_1.php?site_map_item_id=95";
            break;
        case 20:
            ...
            m_returnObject.webSite=@"http://www.hc.org.tw/";
            break;
        case 21:
            ...
            m_returnObject.webSite=@"http://www.tzu-shin.com.tw/products-3_1297-tchinese.html";
            break;
        case 22:
            ...
            m_returnObject.webSite=@"http://www.snhome.com.tw/";
            break;
        case 23:
            ...
            m_returnObject.email=@"";
            m_returnObject.webSite=@"http://www.etan.com.tw/huide_hosp/big5/site_item_content_4.php?site_map_item_id=89";
            break;
        case 24:
            ...
            m_returnObject.email=@"";
            m_returnObject.webSite=@"http://www.steh.gov.tw/";
            break;
        case 30:
            ...
            m_returnObject.webSite=@"http://www.recyclesources.com.tw/usersite/26597888_index.html?sysid=18297";
            break;
        case 31:
            ...
            m_returnObject.email=@"";
            m_returnObject.webSite=@"http://www.medfirst.com.tw/";
            break;
        case 32:
            ...
            m_returnObject.email=@"";
            m_returnObject.webSite=@"http://www.lawbroker.com.tw/";
            break;
        default:
            break;
    }
