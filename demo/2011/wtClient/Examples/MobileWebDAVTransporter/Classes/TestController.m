...
//  TestController.m
//
//  $URL: http://wtclient.googlecode.com/svn/trunk/Examples/MobileWebDAVTransporter/Classes/TestController.m $
//
//  $Revision: 17 $
//  $LastChangedDate: 2009-02-08 04:33:49 +0800 (Sun, 08 Feb 2009) $
...
- (IBAction)downloadFile:(id)sender {
    ...
    NSData *testData=[NSData dataWithContentsOfFile:self.filePath];
    NSInteger length=[testData length];
    unsigned char buffer[length];
    [testData getBytes:&buffer];
