...
//port : The default port is 5222, if port number is nil.
...
- (BOOL)registerWithPassword:(XMPPJID *)myJID Password:(NSString *)password error:(NSError **)errPtr;
...
- (BOOL)authenticateWithPassword:(XMPPJID *)myJID Password:(NSString *)password error:(NSError **)errPtr;
