...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"5.0")) {
        [[UINavigationBar appearance] setBackgroundImage:[TUNinePatchCache imageOfSize:CGSizeMake(320, 44) forNinePatchNamed:@"img_actionbar"] forBarMetrics:UIBarMetricsDefault]; //或 [navigationController.navigationBar setBackgroundImage:myImage forBarMetrics:UIBarMetricsDefault]
