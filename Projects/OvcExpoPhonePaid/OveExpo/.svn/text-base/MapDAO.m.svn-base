...
-(NSString*)getExitByFromAndToMapId:(NSInteger)fromMapId withToMapId:(NSInteger)toMapId{
    ...
    [LocationInfoObject targetPosition].name=[NSString stringWithFormat:@"%@",[qp getValue:@"name" withIndex:0]];
...
-(void)settingInitNowPosition{
    ...
    [LocationInfoObject nowPosition].name=[qp getValueUnderNode:@"location" withKey:@"name" withIndex:0 withDepth:1];
    [LocationInfoObject nowPosition].pointId=[qp getValueUnderNode:@"pointList" withKey:@"pointId" withIndex:0];
    [qp release];
}
