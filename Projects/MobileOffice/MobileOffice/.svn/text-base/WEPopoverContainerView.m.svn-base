...
permittedArrowDirections:(UIPopoverArrowDirection)permittedArrowDirections
	...
	if ((self = [super initWithFrame:CGRectZero])) {
        ...
        //TODO by change
        /** using 9 patch and mask */
        UIImage *frame=[TUNinePatchCache imageOfSize:correctedSize forNinePatchNamed:@"popup_frame"];
        UIImage *finalImage=[FcDrawing clipTextureMask:
        [FcDrawing drawDeviceGrayImage:
         [TUNinePatchCache imageOfSize:correctedSize forNinePatchNamed:@"popup_mask"]] withImage:[FcDrawing loadUIImage:@"popup_material" withType:@"png"]];
        //[FcDrawing merge2Images:frame withImage:finalImage withSize:bgRect.size];
        frameImage=[frame retain];
        bgImage=[finalImage retain];
...
- (void)drawRect:(CGRect)rect {
    [frameImage drawInRect:bgRect blendMode:kCGBlendModeNormal alpha:1.0];
