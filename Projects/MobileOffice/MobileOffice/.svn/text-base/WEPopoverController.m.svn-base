...
- (WEPopoverContainerViewProperties *)defaultContainerViewProperties {
	...
	NSString *bgImageName = @"popup_material.png";
	CGFloat bgMargin =7.0;
	...
	ret.upArrowImageName = @"popup_point_up.png";
	ret.downArrowImageName = @"popup_point_down.png";
	ret.leftArrowImageName = @"popup_point_left.png";
	ret.rightArrowImageName = @"popup_point_right.png";
	return ret;
}
