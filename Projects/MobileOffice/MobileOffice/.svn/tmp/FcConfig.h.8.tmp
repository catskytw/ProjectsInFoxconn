...
//project url
#define URLPREFIX @"http://10.62.13.31:8080" /*@"http://10.62.13.2:8080"*/
...
#define getBusinessTrabelInfo(sessionId,workNo,jsonString) [[NSString stringWithFormat:@"%@getBusinessTravelInfo?sessionId=%@&workNO=%@&btiParam=%@",AttendanceService,sessionId,workNo,jsonString]stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]
...
#define SIGHOFF_SHOWMSG @"SIGHOFF_SHOWMSG"
#define SIGHOFF_CLOSEMSG @"SIGHOFF_CLOSEMSG"
#define SHOW_ACTIVITY_INDICATOR @"SHOW_ACTIVITY_INDICATOR"
//typedef section
typedef enum {
