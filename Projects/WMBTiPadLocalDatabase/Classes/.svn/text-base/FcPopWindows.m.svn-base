...
-(void)show:(UIView*)parentView{
    ...
    applicationViewController.tabBarController.tabBar.userInteractionEnabled=NO;
...
{
    [super viewDidLoad];
    [closeBtn setTitle:(_closeBtnString==nil)?AMLocalizedString(@"close", nil):_closeBtnString forState:UIControlStateNormal];
    int btnSpace=55;
    //set size
    ...
    [frameImage setImage:[TUNinePatchCache imageOfSize:windowSize forNinePatchNamed:@"popup_bg2"]];
