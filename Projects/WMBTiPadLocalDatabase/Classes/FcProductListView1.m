...
-(void)fillData:(FcProductButtonView1*)productButton{
	...
	if(queryPattern!=nil){
        ...
        NSString *path=[NSString stringWithFormat:@"%@/%@", [NSString documentPath],[NSString fetchFileName:picFileName]];
        [productButton.picture setImage:[UIImage imageWithContentsOfFile:path]];
