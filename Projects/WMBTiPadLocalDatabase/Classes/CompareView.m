...
-(void)refreshComparePanel:(NSInteger)numof{
    ...
    NSString *path=[NSString stringWithFormat:@"%@/%@",[NSString documentPath],[NSString fetchFileName:thisObject.picURL]];
    [thisView.picture setImage:[UIImage imageWithContentsOfFile:path]];
...
-(void)addCompareProduct:(NSNotification*)notification{
    ...
    [query prepareDicWithDictionary:[QuerySQLProcess queryProductDetail:productId]];
