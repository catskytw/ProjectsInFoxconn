...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
	...
	[thisCell.timeNum setText:(station.timeMin==-1)?@"-":[NSString stringWithFormat:@"%i",station.timeMin]];
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{	
	...
	switch (buttonIndex) {
		...
		case 3:
			...
			[[GoogleMapRoutePlainViewController alloc]initWithAnnotationClickFlag:NO withStartLocation:thisPostition withType:noneQuery];

			//routePlanView.startPOILocation=NullPOIPosition;
			routePlanView.lat=stationInfo.latitude;
			routePlanView.lon=stationInfo.longitude;
