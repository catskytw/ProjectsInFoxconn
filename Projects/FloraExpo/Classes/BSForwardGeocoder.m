...
-(void)startGeocoding
{
	...
	{
		// Create the url to Googles geocoding API, we want the response to be in XML
		NSString* mapsUrl = [[NSString alloc] initWithFormat:@"http://maps.google.com/maps/api/geocode/xml?address=%@&sensor=false&bounds=24.674037,121.282682|25.301386,122.005806&language=zh-TW", 
							 searchQuery];
		NSLog(@"%@",mapsUrl);
		// Create the url object for our request. It's important to escape the 
		// search string to support spaces and international characters
