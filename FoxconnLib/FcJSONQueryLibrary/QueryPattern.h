...
@interface QueryPattern : NSObject {
    NSString *_startSyncNotificationName;
    NSString *_endSyncNotificationName;
@private
	NSDictionary *jsonDic;
}
@property(nonatomic,retain)NSString *_startSyncNotificationName;
@property(nonatomic,retain)NSString *_endSyncNotificationName;
...
/**
 ...
 @param:若有指定notification,可於此指定. notification.userinfo裡,key為Component
 */
...
/**
 依nodeString 取值
 e.g. productTypeList[1].productList[5].productName
 */
