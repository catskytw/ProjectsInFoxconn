...
-(void)downloadDone:(UIImage*)theImage{
	...
	if(notificationName!=nil){
        NSDictionary *targetDic=[NSDictionary dictionaryWithObject:target forKey:@"Component"];
		[[NSNotificationCenter defaultCenter]postNotificationName:notificationName object:nil userInfo:targetDic];
	}
}
