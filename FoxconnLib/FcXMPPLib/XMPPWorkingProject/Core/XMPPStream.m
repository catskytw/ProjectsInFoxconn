...
- (BOOL)connectWithAddress:(NSString *)host Port:(int)port error:(NSError **)errPtr
{
...
- (BOOL)registerWithPassword:(XMPPJID *)_myJID Password:(NSString *)password error:(NSError **)errPtr
{
    if (myJID != nil) {
        [myJID release];
    }
    ...
    return [self registerWithPassword:password error:errPtr];
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
- (BOOL)authenticateWithPassword:(XMPPJID *)_myJID Password:(NSString *)password error:(NSError **)errPtr
{
    if (myJID!=nil) {
        [myJID release];
    }
